...
export default async function PostPage({
  ...
  return (
    <article className="prose prose-slate dark:prose-invert flex flex-col max-w-none px-4 py-8 md:px-10 md:py-20 [&_pre]:overflow-x-auto [&_pre::-webkit-scrollbar]:hidden">
